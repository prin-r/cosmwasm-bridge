...
use crate::msg::{HandleMsg, InitMsg, QueryMsg, ValidatorWithPower, VerifyOracleDataResponse, GetValidatorPowerResponse};
use crate::state::{validators_power, total_validator_power, block_details, BlockDetail, owner, block_details_read, total_validator_power_read, validators_power_read, candidate_block_details, total_validator_power_last_updated_read, CandidateBlockDetail, total_validator_power_last_updated, candidate_block_details_read, verified_results, verified_results_read, owner_read};
...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        HandleMsg::UpdateValidatorsPower { block_height, validators } => try_update_validators_power(deps, env, block_height, validators),
